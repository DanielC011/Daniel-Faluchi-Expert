...
export const IncludedDeliverables: React.FC = () => {
  return (
    <section id="o-que-voce-recebe" className="relative border-t border-zinc-900 bg-[#050505] py-16 sm:py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div 
          ...
          className="mt-12 rounded-3xl border border-zinc-800 bg-zinc-900/50 p-6 sm:p-10 shadow-2xl"
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {siteConfig.deliverables.map((item, index) => (
              <div
                ...
                className="flex items-center gap-3 rounded-xl border border-zinc-800/80 bg-zinc-950/80 p-4 transition-all hover:border-zinc-700 hover:bg-zinc-900"
              >
                <div className="flex h-5 w-5 flex-shrink-0 items-center justify-center rounded bg-green-500/20 text-green-400 font-bold text-xs">
                  ✓
                </div>
